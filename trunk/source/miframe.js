...
/** @class
  ...
  * @license <a href="http://www.gnu.org/licenses/lgpl.html">LGPL 3.0</a>
  * @author Doug Hendricks. Forum ID: <a href="http://extjs.com/forum/member.php?u=8730">hendricd</a>
  * @donate <a href="http://donate.theactivegroup.com"><img src="http://www.paypal.com/en_US/i/btn/x-click-butcc-donate.gif"></img></a>
  * @constructor
  * @param {HTMLElement} el (optional) Existing iframe element or its id to Manage.
 ...
 Ext.ux.ManagedIFrame = function(){
    ...
    this.addEvents({
         ...
         * Note: This event is only available when overwriting the iframe document using the {@link #Ext.ux.ManagedIFrame-update} method and to pages
         * retrieved from a "same-origin" domain.
        ...
        /**
         * Note: This event is only available when overwriting the iframe document using the {@link #Ext.ux.ManagedIFrame-update} method and to documents
         * retrieved from a "same-origin" domains.
         * Fires when(if) the frames window object raises the unload event<br />
       ...
       /**
         ...
         * @event message
         * @param {Ext.ux.ManagedIFrame} this
         * @param {Object} message members:  <ul>
         * <li><b>type</b> {string} <p class="sub-desc">literal "message"</p></li>
         * <li><b>data</b> {Mixed} <p class="sub-desc">the message payload]</p></li>
         * <li><b>domain</b> {String} <p class="sub-desc">the document domain from which the message originated </p></li>
         * <li><b>uri</b> {string} <p class="sub-desc">the document URI of the message sender</p></li>
         * <li><b>source</b>  (Object) <p class="sub-desc">the window context of the message sender</p></li>
         * <li><b>tag</b>  {string} <p class="sub-desc">optional reference tag sent by the message sender }</p></li></ul>
         */
        "message" : true  //"message:tagName"  is supported for X-frame messaging
        /**
